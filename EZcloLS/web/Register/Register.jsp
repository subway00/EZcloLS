        ...
        <div class="container-fluid" p-0>
            <div class="header row">
                ...
                <div class="nav col">
                    <div class="nav-box">
                        ...
                        <div class="options"> <a class= "nonActive" href="/EZcloLS/AboutUs/AboutUs.jsp">關於我們</a> </div>
                    </div>
                </div>
            </div>
            <div class="content row">
                ...
                <div class="register-box col">
                    <form action="/EZcloLS/RegisterController" method="POST" id="register_form" role="form" data-toggle="validator">
                        <div class="email-box">
